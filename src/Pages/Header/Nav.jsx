  ...
  return (
    <>
      <div className="bg-gray-50 text-gray-800">
        {/* Navbar */}
        <header className="bg-gradient-to-r from-teal-500 to-cyan-600 shadow">
          <div className="container mx-auto flex justify-between items-center px-6 py-4 text-white">
            <div className="flex items-center space-x-4">
              <Link to="/">
                <div className="text-3xl font-extrabold text-neutral-50">
                  Auctify
                </div>
              </Link>
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search..."
                  className="border rounded-full px-4 py-2 w-64 focus:ring-2 focus:ring-orange-300 text-black"
              ...
              {userInfo ? (
                ...
                <Link
                  to="/signin"
                  className="bg-orange-400 px-6 py-2 rounded-full font-bold hover:bg-orange-500"
                >
                  Login/Signup
                </Link>
              )}

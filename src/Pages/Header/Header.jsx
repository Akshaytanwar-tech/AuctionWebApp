        ...
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          >
            <span className="ml-3 text-3xl font-bold">
              <span className="text-cyan-500">Auctiofy</span>
            </span>
          </Link>
          ...
          <nav className="flex lg:w-2/5 flex-wrap lg:justify-end items-center text-base md:ml-auto">
            ...
            <Link to="/shoping" className="relative inline-flex items-center">
              <span className="relative inline-flex items-center rounded px-2.5 py-1.5 font-medium">
                <span className="ml-1.5 text-base text-gray-600 hover:text-gray-900">
                  Shopping
                </span>
            ...
            <Link to="/cart" className="relative inline-flex items-center mr-3">
              <span className="relative inline-flex items-center rounded px-2.5 py-1.5 font-medium">
              ...
              <div className="mr-4">
                ...
                {isMenuOpen && (
                  <div
                    ...
                    className=" absolute z-40 bg-white divide-y divide-gray-100 rounded-lg shadow-lg  mt-2 w-auto left-auto"
                  >
            ...
            {userInfo && userInfo.isAdmin && (
              <div className="hover:text-gray-900 mr-6">
                ...
                {isOpenAdmin && (
                  <div
                    id="dropdownAvatar"
                    className="absolute z-40 bg-white divide-y divide-gray-100 rounded-lg shadow-lg  mt-2 w-48 sm:left-auto"
                  >
            ...
            {userInfo ? (
              <div className="relative group">
                ...
                {isOpen && (
                  <div
                    id="dropdownAvatar"
                    className="absolute z-40 bg-white divide-y divide-gray-100 rounded-lg shadow-lg right-0 mt-2 w-48 sm:left-auto sm:right-0"
                  >

...
// Create new auction
// auctionRouter.post('/',
export const createAuction = (isAuth, isSeller, async (req, res) => {
    try {
...
// auctionRouter.get('/:id', 
export const getAuction = (isAuth, async (req, res) => {
    try {
...
// auctionRouter.post('/:id/bids', 
export const bidAuction = (isAuth, async (req, res) => {
    try {
        const auction = await Auction.findById(req.params.id);
...
// auctionRouter.delete('/:id', 
export const deleteAuction = (isAuth, isAdmin, async (req, res) => {
    try {
